  ...
  const members = [
    {
      ...
      about:
        "ربيع لكواش رئيس المجلس الاستشاري للشباب، شاب حاصل على الإجازة في القانون، فنان بصري شغوف برسم الوجوه وتصميم الشخصيات. أحب القيادة والعمل الجماعي، وطموحي كبير لتقديم مشاريع ومبادرات تخدم قريتي الصغيرة رأس العين الشاوية، والمساهمة في تنميتها ثقافيًا وفنيًا.",
    },
    {
      id: 2,
      name: "زكرياء ربيعي",
    ...
    },
    {
      ...
      about:
        "وفاء الشعيبي 20 سنة  القاطنة بدوار الصوالحة القوارشة جماعة رأس العين طالبة جامعية في كية الاقتصاد والتدبير وأستاذة في مركز الحياة برأس العين الشاوية وعضوة في مجلس الشباب",
    },
    {
      id: 4,
      name: "سهام جمال",
      ...
      about:
        "سهام جمال، شابة من دوار أولاد الريو القوارشة التابع لجماعة رأس العين – إقليم سطات، أبلغ من العمر 25 سنة. أزاول مهمة مقررة المجلس الاستشاري للشباب بجماعة رأس العين، إيماناً مني بأهمية دور الشباب في تحقيق التنمية المحلية والمشاركة الفعالة في خدمة الساكنة.",
    },
  ];
